...
import SelectThumbnail from '../../components/Items/Item/Common/SelectTumbnail';
...
export const ItemRoutes = () => {
  return (
    <Switch>
      ...
      <Route exact path="/item/new/:id/thumbnail" component={SelectThumbnail} />
      ...
      <Route exact path="/item/edit/:id/thumbnail" component={SelectThumbnail} />
